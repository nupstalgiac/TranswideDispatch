package transwide.dev.dispatch.Model;
...
public class Order {
    ...
    public Order(String customer, String address, String price, String cementQuantity, String remarks, String phoneNumber, String cementType, String deliveryTerms) {
        Customer = customer;
        Address = address;
        Price = price;
